                ...
                <div class="collapse navbar-collapse ">
                    <ul class="nav navbar-nav">
                        <li ><a href="TravellingSystem.jsp">TravellingHome</a></li>
                       	...
                       	<li class="active"><a href="LocalRouteReservation.jsp?txt_from=null&txt_to=null">Local Route Reservation</a></li>
    ...
    <section id="feature" >
        <div class="container">
           <div class="center wow fadeInDown">
                <h2>Local Route Reservation</h2>
			<div class="col-md-6 col-md-offset-3">
			<%
			Dbconn db=new Dbconn();
    		Connection con=db.conn();
    		Statement st=con.createStatement();
    		ResultSet rs=st.executeQuery("select * from localpmtroute group by src");
    		Statement st1=con.createStatement();
    		ResultSet rs1=st1.executeQuery("select * from localpmtroute group by dest");
			
			%>
			<form role="form" action="LocalRouteReservation.jsp" method="post">
			...
			<tr>
			<td class="col-md-3"><label for="txt_Uname">Select Transport:</label></td>
		    <td class="col-md-5"><select name="txt_transport" id="txt_transport"  class="form-control">
		    <option value="">---select transport type---</option>
		    <option value="pmtBus">PMT Bus</option>
		    </select></td>
		    </tr>
 			...
 			if(!from.contains("null") && !to.contains("null"))
			{
				...
				ResultSet rs2=st2.executeQuery("select * from localpmtroute where src='"+from+"' and dest='"+to+"'");				
				%>
			...
			<%
			System.out.println("img name===>"+from.toLowerCase()+"to"+to.replace(" ", "").toLowerCase());
			}
			%>
			<tr>
			<td><input type="hidden" value="localpmtroute" name="txt_sys"> </td>
			</tr>
			<tr>
			<td class="col-md-6" colspan="7" align="center" ><input type="submit" class="btn-primary" name="btn_Submit" id="btn_Submit" Value="Book Ticket"><br>
			 ...
			 <img alt="Not avilable" src="images/localroutepmt/<%=from.toLowerCase()+"to"+to.replace(" ", "").toLowerCase()%>.PNG" width="550;" height="350;"> 
