    ...
    <section id="feature" >
        <div class="container">
           <div class="center wow fadeInDown">
			...
			<tr>
			<td class="col-md-6" align="center" ><a href="LongBusSystem.jsp?txt_from=null&txt_to=null"><button class="btn-primary" >Bus System</button></a>
			<a href="LongTrainSystem.jsp?txt_from=null&txt_to=null"><button class="btn-primary" >Train System</button></a>
			<a href="LongPlaneSystem.jsp?txt_from=null&txt_to=null"><button class="btn-primary" >Plane System</button></a></td>
			</tr>
			</table>
			</div>
