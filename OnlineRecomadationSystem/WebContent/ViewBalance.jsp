                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li ><a href="AddAccount.jsp">Add Bank Account</a></li>
                       	...
                       	<li ><a href="DebitAmount.jsp">Debit Amount</a></li>
                       		<li class="active"><a href="ViewBalance.jsp?bank=null">View Balance</a></li>
                       	<li class="dropdown">
    ...
    <section id="feature" >
        <div class="container">
           <div class="center wow fadeInDown">
			...
			<form role="form" action="ViewBalance.jsp" method="post">
			<div class="form-group">
			<table class="table table-responsive table-bordered">

			<tr>
			<td class="col-md-2"><label for="txt_Ubank">Select Bank:</label></td>
		    <td class="col-md-6"><select type="text" class="form-control" name="bank"  required id="bank" placeholder="Select Bank">
		    <%
		    while(rs.next())
            {
			...
			<tr>
			<td class="col-md-6" colspan="2" align="center" ><input type="submit" class="btn-primary" name="btn_Submit" id="btn_Submit" Value="View Transaction"></td>
			</tr>
			</table>
			</div>
			</form> 			
			...
			<%
			String txtBank=request.getParameter("bank");
			if(!txtBank.equals("null"))
			{

			Statement st1=con.createStatement();
			ResultSet rs1=st1.executeQuery("select * from transaction where User='"+uname+"' and Bank='"+txtBank+"'");
			...
			<tr>
			<td class="col-md-2" >Credit amount</td>
			<td class="col-md-2" >Debit amount</td>
		    ...
		    %>
		    <tr>
			<td class="col-md-2" ><%=rs1.getString(3) %></td>
			<td class="col-md-2" ><%=rs1.getString(4) %></td>
			<td class="col-md-2" ><%=rs1.getString(5) %></td>
			<td class="col-md-2" ><%=rs1.getString(6) %></td>
			</tr>
		    <%
		    }
		    %>
