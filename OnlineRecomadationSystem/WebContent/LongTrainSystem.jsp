    ...
    <section id="feature" >
        <div class="container">
           <div class="center wow fadeInDown">
                <h2>Local Train Reservation</h2>
			<div class="col-md-6 col-md-offset-3">
			<%
			Dbconn db=new Dbconn();
    		Connection con=db.conn();
    		Statement st=con.createStatement();
    		ResultSet rs=st.executeQuery("select * from longtrainroute group by src");
    		Statement st1=con.createStatement();
    		ResultSet rs1=st1.executeQuery("select * from longtrainroute group by dest");
			
			%>
			<form role="form" action="LongTrainSystem.jsp" method="post">
 			...
 			if(!from.contains("null") && !to.contains("null"))
			{
				...
				ResultSet rs2=st2.executeQuery("select * from longtrainroute where src='"+from+"' and dest='"+to+"'");				
				%>
			...
			%>
			<tr>
			<td><input type="hidden" value="longtrainroute" name="txt_sys"> </td>
			</tr>
			<tr>
			<td class="col-md-6" colspan="7" align="center" ><input type="submit" class="btn-primary" name="btn_Submit" id="btn_Submit" Value="Book Ticket"><br>
			 ...
			 <img alt="Not avilable" src="images/longtrain/<%=from.toLowerCase()+"to"+to.toLowerCase()%>.PNG" width="550;" height="350;"> 
				</div>
