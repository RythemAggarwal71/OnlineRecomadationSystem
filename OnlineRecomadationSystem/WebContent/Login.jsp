        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header center wow fadeInDown">
                    ...
                    <a class="navbar-brand" href="index.html">Socio Rank Algo for Recommendation System:- Bank System</a>
                </div>
				
             <a href="http://localhost:8990/SocioRankRecommendation/index.jsp" style="margin-left: 60%;"><input type="button" class="btn btn-primary" value="Back to Recommendation"></a>   
            </div><!--/.container-->
        </nav><!--/nav-->
