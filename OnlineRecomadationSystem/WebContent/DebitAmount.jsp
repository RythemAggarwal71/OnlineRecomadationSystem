                ...
                <div class="collapse navbar-collapse ">
                    <ul class="nav navbar-nav">
                        ...
                        <li ><a href="AddAccount.jsp">Add Bank Account</a></li>
                       	...
                       	<li class="active"><a href="DebitAmount.jsp?bank=null">Debit Amount</a></li>
    ...
    <section id="feature" >
        <div class="container">
           <div class="center wow fadeInDown">
			...
			<form role="form" action="DebitAmount" method="post">
			...
			<tr>
			<td class="col-md-6" colspan="2" align="center" ><input type="submit" class="btn-primary" name="btn_Submit" id="btn_Submit" Value="Debit Ammount"></td>
			</tr>
			</table>
			</div>
			</form> 			
